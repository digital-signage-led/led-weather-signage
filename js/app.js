...
import { APP_VERSION, DATA_VERSION, MAP_VERSION } from "./version.js?v=pref372";
import {
  canonicalContent,
  canonicalRegion,
  contentTitle,
  ...
  listRegions,
  loadCatalog
} from "./catalog.js?v=pref372";
import { adaptWeather, aggregateRegion } from "./weather-data.js?v=pref372";
import { loadMapSvg, mountMap, placeCardsAroundMap, projectCity } from "./map-renderer.js?v=pref372";
import { formatStamp, renderCityCard, renderPin, pinRadiusForViewBox, pinRadiusForMatchingScreen, pickNoteWeather, weatherTone, renderNoteIcon, renderPrecipTodLegend } from "./weather-renderer.js?v=pref372";
import { applyCardScale, applyLockedCards, applyMapTransform, applyPrecipLegend, applyTitleScale, bindCardEditor, bindMapControls, bindMapEditor, bindOkinawaEditor, bindPrecipLegendEditor, CARD_POS_MAX, CARD_POS_MIN, CARD_SCALE_MAX, CARD_SCALE_MIN, TITLE_SCALE_MAX, TITLE_SCALE_MIN, centerCityCards, containMapInStage, freezeCardLayout, initLayoutDefaults, isCustomLayout, listCardPositions, loadCardScale, loadLayout, loadTitleScale, moveLockedCard, resetCardScale, resetLayout, resetTitleScale, saveCardScale, saveLayout, saveTitleScale, snapshotLayoutDefaults } from "./studio-layout.js?v=pref372";
import { expandForecast, formatNoteHtml, noteFor } from "./forecast.js?v=pref372";
import { renderWeeklyTable } from "./table-renderer.js?v=pref372";
import {
  ...
  readViewport,
  showAuxiliary
} from "./viewport.js?v=pref372";
import { msUntilIconPhaseChange } from "./jma-icons.js?v=pref372";
import { fetchJmaWeather } from "./jma-live.js?v=pref372";
import { buildWeekPoints, fetchWeekAlert, renderWeekPointsHtml } from "./week-points.js?v=pref372";
...
/** 週間表の1ページ都市数。中部は4都市ずつ。 */
function tablePageSize(regionId) {
  return String(regionId || "").toLowerCase() === "chubu" ? 4 : 5;
}
