...
import { canonicalRegion, isNational } from "./catalog.js?v=pref352";
import { cardSizePct } from "./viewport.js?v=pref352";
import { MAP_VERSION } from "./version.js?v=pref352";

import { jmaIconFile } from "./jma-icons.js?v=pref352";
