...
import { canonicalRegion, isNational } from "./catalog.js?v=pref367";
import { cardSizePct } from "./viewport.js?v=pref367";
import { MAP_VERSION } from "./version.js?v=pref367";

import { jmaIconFile } from "./jma-icons.js?v=pref367";
