...
import { canonicalRegion, isNational } from "./catalog.js?v=pref365";
import { cardSizePct } from "./viewport.js?v=pref365";
import { MAP_VERSION } from "./version.js?v=pref365";

import { jmaIconFile } from "./jma-icons.js?v=pref365";
