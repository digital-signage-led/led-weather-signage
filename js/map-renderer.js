...
import { canonicalRegion, isNational } from "./catalog.js?v=pref353";
import { cardSizePct } from "./viewport.js?v=pref353";
import { MAP_VERSION } from "./version.js?v=pref353";

import { jmaIconFile } from "./jma-icons.js?v=pref353";
