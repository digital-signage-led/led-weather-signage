...
import { canonicalRegion, isNational } from "./catalog.js?v=pref366";
import { cardSizePct } from "./viewport.js?v=pref366";
import { MAP_VERSION } from "./version.js?v=pref366";

import { jmaIconFile } from "./jma-icons.js?v=pref366";
